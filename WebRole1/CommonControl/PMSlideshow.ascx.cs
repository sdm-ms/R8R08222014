    ...
    public partial class PMSlideshow : System.Web.UI.UserControl
    {
        ...
        protected List<RatingGroup> GetRatingOverTimesData()
        {
            ...
            List<RatingGroup> ratingGroupList = 
                ...
                let mgMostActive = e.RatingGroups.OrderByDescending(mg => mg.VolatilityTrackers.Single(x => x.DurationType == (int) VolatilityDuration.oneDay).Volatility).FirstOrDefault()
