    ...
    public partial class Slideshow : System.Web.UI.UserControl
    {
        ...
        protected List<TblRowRatingSummary> GetRatingsOfBestData()
        {
            ...
            foreach (var summary in entityRatingSummary)
            {
                ...
                {
                    item.Rating = Convert.ToDecimal(NumberandTableFormatter.FormatAsSpecified(item.Rating, 1, item.ColumnID));
                }
            }
        ...
        protected List<RatingGroup> GetRatingOverTimesData()
        {
            ...
            List<RatingGroup> ratingGroupList = 
                ...
                let mgMostActive = e.RatingGroups.OrderByDescending(mg => mg.VolatilityTrackers.FirstOrDefault(x => x.DurationType == (int) VolatilityDuration.oneDay).Pushback).FirstOrDefault()
        ...
        public string GetRatingsOfBestGraphAsString(TblRowRatingSummary theSummary)
        {
            ...
            try
            {
                string theRatingOfBestString = CacheManagement.GetItemFromCache(cacheString) as string;
                if (theRatingOfBestString == null || theRatingOfBestString == "")
                {
                    ...
                    CacheManagement.AddItemToCache(cacheString, new string[] { }, theRatingOfBestString, new TimeSpan(0, 10, 0));
                }
        ...
        public string GetRatingOverTimeGraphAsString(RatingGroup theRatingGroup)
        {
            try
            {
                ...
                string theRatingOverTimeString = CacheManagement.GetItemFromCache(cacheString) as string;
                if (theRatingOverTimeString == null || theRatingOverTimeString == "")
                {
                    ...
                    CacheManagement.AddItemToCache(cacheString, new string[] { }, theRatingOverTimeString, new TimeSpan(0, 10, 0));
                }
