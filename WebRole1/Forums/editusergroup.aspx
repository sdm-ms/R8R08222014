		...
		<tr valign="top">
			<td height="100%">
				...
				<asp:Repeater id="rptAllowed" runat="server" EnableViewState="False" OnItemCommand="rptAllowed_ItemCommand">
					<ItemTemplate>
					    <asp:linkbutton runat="server" id="btnRemoveUser" CommandName="remove" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "UserID") %>' meta:resourcekey="btnRemoveUserResource1"><%# DataBinder.Eval(Container.DataItem, "Username") %></asp:linkbutton> <b>;</b> </ItemTemplate>
				</asp:Repeater>
				</div>
			</td>
			<td>
				...
				<asp:Repeater id="rptDenied" runat="server" EnableViewState="False" OnItemCommand="rptDenied_ItemCommand">
					<ItemTemplate>
					    <asp:linkbutton runat="server" id="btnAddUser" CommandName="add" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "UserID") %>' meta:resourcekey="btnAddUserResource1"><%# DataBinder.Eval(Container.DataItem, "Username") %></asp:linkbutton> <b>;</b> </ItemTemplate>
				</asp:Repeater>
				</div>
			</td>
		</tr>
