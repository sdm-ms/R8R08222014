<%@ Page Language="C#" AutoEventWireup="true" Codebehind="adduser.aspx.cs" Inherits="aspnetforum.adduser"
...
<asp:Content ContentPlaceHolderID="AspNetForumContentPlaceHolder" ID="AspNetForumContent" runat="server">
	...
	<p>
	<asp:Label ID="lblDescription" runat="server" EnableViewState="False" meta:resourcekey="lblDescriptionResource1">Use this page to add a new user manually, without requiring a user to go through the registration process</asp:Label></p>
	<table class="noborder" cellpadding="7">
		...
		<tr><td colspan="2"><asp:Button CssClass="gradientbutton" ID="btnAdd" runat="server" Text="add" OnClick="btnAdd_Click" meta:resourcekey="btnAddResource1" /></td></tr>
	</table>
