...
function CheckUserName() {
	...
	<table id="registerTable" runat="server" cellpadding="11" class="noborder gray">
		<tr>
		...
		<tr>
			...
			<td><asp:Label ID="lblCaptcha" runat="server" EnableViewState="False" meta:resourcekey="lblCaptchaResource1">Enter the code shown:</asp:Label>
