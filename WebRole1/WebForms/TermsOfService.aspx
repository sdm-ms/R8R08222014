<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/StandardPage.master" AutoEventWireup="true" Inherits="TermsOfService" Codebehind="TermsOfService.aspx.cs" %>
...
By accessing and using Rateroo, you accept and agree to be bound by the terms and
    ...
    <br>
    f. upload, post, email, transmit or otherwise make available any Content that infringes
    ...
    of law;<br>
    <br>
    j. provide material support or resources (or to conceal or disguise the nature,
    ...
    to section 219 of the Immigration and Nationality Act;<br>
    <br>
    ...
    <br>
    a. YOUR USE OF RATEROO AND SOFTWARE ARE AT YOUR SOLE RISK. RATEROO AND SOFTWARE
    ARE PROVIDED ON AN "AS IS" AND "AS AVAILABLE" BASIS. YAHOO AND ITS SUBSIDIARIES,
    AFFILIATES, OFFICERS, EMPLOYEES, AGENTS, PARTNERS AND LICENSORS EXPRESSLY DISCLAIM
    ...
    <br>
    b. RATEROO AND ITS SUBSIDIARIES, AFFILIATES, OFFICERS, EMPLOYEES, AGENTS, PARTNERS
    AND LICENSORS MAKE NO WARRANTY THAT (i) RATEROO OR SOFTWARE WILL MEET YOUR REQUIREMENTS;
    (ii) RATEROO OR SOFTWARE WILL BE UNINTERRUPTED, TIMELY, SECURE OR ERROR-FREE; (iii)
    THE RESULTS THAT MAY BE OBTAINED FROM THE USE OF RATEROO OR SOFTWARE WILL BE ACCURATE
    OR RELIABLE; (iv) THE QUALITY OF ANY PRODUCTS, SERVICES, INFORMATION OR OTHER MATERIAL
    PURCHASED OR OBTAINED BY YOU THROUGH RATEROO OR SOFTWARE WILL MEET YOUR EXPECTATIONS;
    AND (v) ANY ERRORS IN THE SOFTWARE WILL BE CORRECTED.<br>
    <br>
    c. ANY MATERIAL DOWNLOADED OR OTHERWISE OBTAINED THROUGH THE USE OF RATEROO OR SOFTWARE
    IS ACCESSED AT YOUR OWN DISCRETION AND RISK, AND YOU WILL BE SOLELY RESPONSIBLE
    FOR AND HEREBY WAIVE ANY AND ALL CLAIMS AND CAUSES OF ACTION WITH RESPECT TO ANY
    DAMAGE TO YOUR COMPUTER SYSTEM, INTERNET ACCESS, DOWNLOAD OR DISPLAY DEVICE, OR
    LOSS OF DATA THAT RESULTS FROM THE DOWNLOAD OF ANY SUCH MATERIAL.<br>
    <br>
    d. NO ADVICE OR INFORMATION, WHETHER ORAL OR WRITTEN, OBTAINED BY YOU FROM RATEROO
    OR THROUGH OR FROM RATEROO OR SOFTWARE SHALL CREATE ANY WARRANTY NOT EXPRESSLY STATED
    IN THE TOS.<br>
    <br>
    e. A SMALL PERCENTAGE OF USERS MAY EXPERIENCE EPILEPTIC SEIZURES WHEN EXPOSED TO
    CERTAIN LIGHT PATTERNS OR BACKGROUNDS ON A COMPUTER SCREEN OR WHILE USING RATEROO
    SERVICE. CERTAIN CONDITIONS MAY INDUCE PREVIOUSLY UNDETECTED EPILEPTIC SYMPTOMS
    EVEN IN USERS WHO HAVE NO HISTORY OF PRIOR SEIZURES OR EPILEPSY. IF YOU, OR ANYONE
    IN YOUR FAMILY, HAVE AN EPILEPTIC CONDITION, CONSULT YOUR PHYSICIAN PRIOR TO USING
    RATEROO SERVICE. IMMEDIATELY DISCONTINUE USE OF RATEROO AND CONSULT YOUR PHYSICIAN
    IF YOU EXPERIENCE ANY OF THE FOLLOWING SYMPTOMS WHILE USING RATEROO SERVICE: DIZZINESS,
    ALTERED VISION, EYE OR MUSCLE TWITCHES, LOSS OF AWARENESS, DISORIENTATION, ANY INVOLUNTARY
    MOVEMENT, OR CONVULSIONS.<br>
    <br>
    •LIMITATION OF LIABILITY<br>
    <br>
    YOU EXPRESSLY UNDERSTAND AND AGREE THAT RATEROO AND ITS SUBSIDIARIES, AFFILIATES,
    OFFICERS, EMPLOYEES, AGENTS, PARTNERS AND LICENSORS SHALL NOT BE LIABLE TO YOU FOR
    ...
    OR OTHER INTANGIBLE LOSSES (EVEN IF RATEROO HAS BEEN ADVISED OF THE POSSIBILITY
    OF SUCH DAMAGES), RESULTING FROM: (a) THE USE OR THE INABILITY TO USE RATEROO SERVICE;
    ...
    THIRD PARTY ON RATEROO SERVICE; OR (e) ANY OTHER MATTER RELATING TO RATEROO SERVICE.<br>
    <br>
    ...
    be no third-party beneficiaries to this agreement.<br>
    <br>
    NOTICE<br>
    <br>
