...
public partial class Prizes : System.Web.UI.Page
{
    ...
    public void MainLinqDataSource_Selecting(object sender, LinqDataSourceSelectEventArgs e)
    {
        ...
        User theUser = theDataAccessModule.DataContext.GetTable<User>().SingleOrDefault(u => u.UserID == (Guid)ClassLibrary1.Misc.UserProfileCollection.GetCurrentUser().GetProperty("UserID"));
