<%@ Control Language="C#" AutoEventWireup="true" Inherits="AnyFieldFilter" Codebehind="AnyField.ascx.cs" %>
<%@ Reference Control= "~/Main/Field/NumberField.ascx" %>
<%@ Reference Control="~/Main/Field/TextField.ascx" %>
