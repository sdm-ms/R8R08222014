...
using TestProject1.IMDbContext;

namespace TestProject1
{

    public partial class TestInMemoryDbContext : DbContext
    {
        ...
        public TestInMemoryDbContext(string connectionString)
        ...
        public TestInMemoryDbContext(DbConnection connection)
