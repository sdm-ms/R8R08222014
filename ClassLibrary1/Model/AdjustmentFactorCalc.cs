...
{
    public static class AdjustmentFactorCalc
    {
        /// <summary>
            ...
            decimal? logBase = null)
        {
            if (logBase == null)
                ...
                return Math.Abs((TrustCalculations.LogBase(value, (decimal) logBase) - TrustCalculations.LogBase(basisValue, (decimal) logBase) ) / (TrustCalculations.LogBase(maxValue, (decimal) logBase) - TrustCalculations.LogBase(minValue, (decimal) logBase)));
        }
        ...
        public static float CalculateExtremeness(decimal value, decimal? logBase, decimal minRating, decimal maxRating)
        {
            ...
            if (logBase == null)
                ...
                midpointRating = (decimal) Math.Pow((double) logBase, (double) ((TrustCalculations.LogBase(maxRating, (decimal) logBase) - TrustCalculations.LogBase(minRating, (decimal) logBase))/2));
            ...
            bool constrainForRetrospectiveAssessment = false)
        {
            ...
            if (enteredValue == basisValue)
                ...
                factor = (TrustCalculations.LogBase(laterValue, logBase.Value) - TrustCalculations.LogBase(basisValue, logBase.Value)) / 
                    (TrustCalculations.LogBase(enteredValue, logBase.Value) - TrustCalculations.LogBase(basisValue, logBase.Value));

            if (constrainForRetrospectiveAssessment)
                factor = TrustCalculations.Constrain(factor, MinimumRetrospectiveAdjustmentFactor, MaximumRetrospectiveAdjustmentFactor);
        ...
        public static decimal GetRatingToAcceptFromAdjustmentFactor(
            ...
            decimal? logBase)
        {
            adjustmentFactor = TrustCalculations.Constrain(adjustmentFactor, MinimumPredictiveAdjustmentFactor, MaximumPredictiveAdjustmentFactor);
            ...
            if (logBase == null)
                ...
                return (decimal)Math.Pow(
                    ...
                    adjustmentFactor * (TrustCalculations.LogBase(value, logBase.Value) - TrustCalculations.LogBase(basisValue, logBase.Value)) + 
                        TrustCalculations.LogBase(basisValue, logBase.Value));
        }
    }
}
