...
{
    public static class PMNumberandTableFormatter
    {
        ...
        public static TblColumnFormatting GetFormattingForTblColumn(int TblColumnID)
        {
            ...
            theFormatting = (TblColumnFormatting)PMCacheManagement.GetItemFromCache(cacheKey, out isInCacheButNull);
            if (theFormatting == null && !isInCacheButNull)
            {
                ...
                PMCacheManagement.AddItemToCache(cacheKey, myDependencies, theFormatting);
            }
            return theFormatting;
        }
