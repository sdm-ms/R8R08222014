...
namespace ClassLibrary1.Model
{
    ...
    public class SQLMultipleChoiceFieldTableInfo
    {
        ...
        public SQLMultipleChoiceFieldTableInfo(IRaterooDataContext iDataContext, FieldDefinition theFieldDefinition)
        {
            ...
            idColumn = new SQLTableColumnDescription() { Name = "ID", ColType = SQLColumnType.typeInt, Nullable = false, PrimaryKey = true, AutoIncrement = true, NonclusteredIndex = false }; 
        ...
        public static SQLUpdateInfoTableSpecification GetSpecification(int fieldDefinitionID, int tblID)
        {
            ...
            return new SQLUpdateInfoTableSpecification() { HasSinglePrimaryKeyField = false, MainTable = mainTableSpecification, Tablename = "VFMC" + fieldDefinitionID.ToString(), HasSameIDAsMainTable = false };
        }
    }
    ...
    public class SQLFastAccessTableInfo
    {
        ...
        {
            return new SQLUpdateInfoTableSpecification() { HasSinglePrimaryKeyField = true, IDIsAutogenerated = false, PrimaryKeyFieldName = "ID", Tablename = "V" + tblID.ToString() };
        }
