...
namespace ClassLibrary1.Model
{
    ...
    public static class SortMenuGenerator
    {
        public static List<SortMenuItem> GetSortMenuForTblTab(IRaterooDataContext theDataContext, int theTblTabID, bool trustedUser)
        {
            ...
            List<SortMenuItem> theSortMenu = PMCacheManagement.GetItemFromCache(cacheKey) as List<SortMenuItem>;
            if (theSortMenu == null)
            {
                ...
                PMCacheManagement.AddItemToCache(cacheKey, new string[] { "CategoriesForTblID" + theTblTabID }, theSortMenu, new TimeSpan(5, 0, 0));
            }
            return theSortMenu;
        }
