    ...
    public class PMRecencyUpdates
    {
        ...
        public static bool UpdateRecency(IRaterooDataContext raterooDB)
        {
            ...
            foreach (var item in itemsToUpdate)
            {
                ...
                float ratingMagnitude = PMAdjustmentFactor.CalculateRelativeMagnitude(ur.EnteredUserRating, ur.PreviousRatingOrVirtualRating, item.RatingCharacteristic.MinimumUserRating, item.RatingCharacteristic.MaximumUserRating, ur.LogarithmicBase); 
        ...
        internal static void RemoveUserRatingFromRecencyUserInteractionStat(UserRating userRating, UserInteractionStat userInteractionStat, TrustTrackerStat trustTrackerStat, float ratingMagnitude, float adjustmentPct)
        {
            ...
            PMTrustTrackingBackgroundTasks.AdjustTrustTrackerStatsTrustLevel(userInteractionStat, trustTrackerStat, weightInCalculatingTrustTotal, weightInCalculatingTrustTotal, originalAverageAdjustmentPct, originalSumWeights);
        }
    }
}
