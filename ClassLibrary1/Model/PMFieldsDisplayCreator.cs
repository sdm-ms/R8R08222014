...
namespace ClassLibrary1.Model
{
    ...
    public class FieldsDisplayCreator
    {
        ...
        {
            var dataAccess = new RaterooDataAccess();
            SQLFastAccess.IdentifyRowRequiringUpdate(dataAccess.RaterooDB, theTblRow.Tbl, theTblRow.TblRowID, false, true);
        ...
        public FieldDisplayHtml GetFieldDisplayHtml(IRaterooDataContext theDataContextToUse, int entityID, FieldsLocation theLocation)
        {
            ...
            FieldDisplayHtml cachedResult = (FieldDisplayHtml)PMCacheManagement.GetItemFromCache(myCacheKey);
            ...
            PMCacheManagement.AddItemToCache(myCacheKey, myDependencies, theDisplayHtml);
            ...
            if (theLocation != FieldsLocation.TblRowPage)
            {
                ...
                if (myFieldDisplayHtml.entityName != "")
                {
                    if (theLocation == FieldsLocation.RowHeading)
                    {
                        ...
                        initialContent.Append(PMRouting.Outgoing(new PMRoutingInfoMainContent(entity.Tbl, entity, null))); // The TblRowID might be 0, so we will need to replace that above
        ...
        protected void ProcessField(ref int numberIncludedAlready, FieldDisplayInfoComplete theField, StringBuilder myStringBuilder, ref StringBuilder imageForProminentDisplay, ref bool addLatLngInfo, ref string latLongInfo)
        {
            ...
            switch ((FieldTypes)theField.FieldDesc.FieldType)
            {
                ...
                default:
                    throw new Exception("Unknown Field type in PMFieldsType:AddItemToTableRow");
