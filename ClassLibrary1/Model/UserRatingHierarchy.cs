    ...
    public partial class R8RDataManipulation
    {
        ...
        TryLabel:
            try
            {
                ...
                TblColumnFormatting theFormatting = NumberandTableFormatter.GetFormattingForTblColumn(topRatingGroup.TblColumnID);
                ...
                theResponse.currentValues = theData.UserRatingHierarchyEntries
                        .Select(m => new RatingAndUserRatingString
                        {
                            ...
                            theUserRating = NumberandTableFormatter.FormatAsSpecified(m.NewValueAfterAdjustment, theRatings.Single(y => y.RatingID == m.RatingId).RatingCharacteristic.DecimalPlaces, theFormatting) 
                        }).ToList();
            }
